...
| Pass rate across 10 runs | mean 99.9%, range 98.5–100% |
| Flake rate | 1.5% (1 inconsistent across 10 runs) |
...
| `completing.spec.ts:111` completing todos > completion state survives a reload | passed | 9/10 | **yes** | passed | passed |
